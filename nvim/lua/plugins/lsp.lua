return {
	...
	},
	{
		...
		config = function()
			...
			-- lspconfig deprecated the standard configuarion of erlangls for NeoVim 0.11 onwards.
			-- this replaces the old 'lspconfig.erlangls.setup`
			vim.lsp.config("erlangls", {
				-- We define the configuration data directly here
				install = {
					package = "erlang-ls", -- This tells the sstem the Mason/OS package name
				},
				cmd = { "erlang_ls" },
				filetypes = { "erlang" },
